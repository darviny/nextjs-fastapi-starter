...
async def hello_fast_api3() -> Dict[str, Any]:
    try:
        ...
        base_prompt = "Using my previous answers, please analyze the political leaning of each response and create a more extreme version of the next question that amplifies my apparent values and beliefs. If my answer shows concern for community welfare, shared resources, and collective responsibility, intensify those themes. If my answer emphasizes individual rights, private property, and personal responsibility, strengthen those aspects. The follow-up question should feel like a natural progression of my own stated views, just taken to a more radical conclusion."
